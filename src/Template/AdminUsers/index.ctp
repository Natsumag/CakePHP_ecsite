    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $adminUser->id], ['class' => 'button']) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $adminUser->id], ['class' => 'button']) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $adminUser->id], ['class' => 'button', 'confirm' => __('Are you sure you want to delete # {0}?', $adminUser->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
