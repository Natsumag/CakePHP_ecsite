...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_name' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'file_type' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'file_path' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'file_size' => 1,
                'created_at' => '2021-04-25 08:27:38',
                'updated_at' => '2021-04-25 08:27:38',
            ],
        ];
        parent::init();
    }
