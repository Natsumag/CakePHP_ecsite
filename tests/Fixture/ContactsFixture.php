...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'admin_user_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'reply_states_flag' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'reply_states_flag' => 1,
                'created_at' => '2021-06-13 00:55:39',
                'updated_at' => '2021-06-13 00:55:39',
            ],
        ];
        parent::init();
    }
