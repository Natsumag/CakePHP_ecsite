...
class MaterialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'material' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2021-05-01 05:30:41',
                'updated_at' => '2021-05-01 05:30:41',
            ],
        ];
        parent::init();
    }
